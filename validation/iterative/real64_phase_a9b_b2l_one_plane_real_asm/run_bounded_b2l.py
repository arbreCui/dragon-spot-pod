#!/usr/bin/env python3
"""Run one B2l process in a fresh process group with fixed resource caps."""
...
def fail(message: str) -> None:
    raise SystemExit(f"B2L BOUNDED PROCESS INVALID: {message}")
...
def main() -> None:
    ...
    print(
        f"B2L BOUNDED PROCESS PASS PROFILE={profile_name} "
