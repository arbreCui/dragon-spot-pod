program CHECK_B2V_REAL_RETURNED
  use GANLIB
  ...
  write(*,'(A)') 'B2V REAL RETURNED POSTERIOR PASS'
  write(*,'(A)') 'B2V ROOT=PROJECTED/1->RETURNED/1 PLANES=3 INDEX-OWNED=YES'
  write(*,'(A,I0,A,I0)') 'B2V COPIED-RECORDS=',copied_records, &
      ' COPIED-32BIT-WORDS=',copied_words
  write(*,'(A,I0,A,I0,A,I0)') 'B2V R64-FLUX=',r64_flux_values, &
      ' R64-SOUR=',r64_sour_values,' R64-QFISS=',r64_qfiss_values
  write(*,'(A,I0,A,I0,A,I0)') 'B2V R32-FLUX=',r32_flux_values, &
      ' R32-SOUR=',r32_sour_values,' R32-QFISS=',r32_qfiss_values
  write(*,'(A,I0,A,I0)') 'B2V QFISS-FORMULA-BITS=',qfiss_formula_values, &
      ' LEAKAGE-BITS=',leakage_checks
  write(*,'(A,I0,A,I0,A,I0)') 'B2V SYSTEM-TX=',tx_checks, &
      ' SYSTEM-S0PHYS=',sphys_checks,' SYSTEM-S0USED=',sused_checks
  write(*,'(A,I0,A,3(I0,1X))') 'B2V RESPONSE-FINITE=',response_values, &
      ' NONZERO-BY-PLANE=',response_nonzero
  write(*,'(A)') 'B2V EMPIRICAL-CONTROLS=0 OUTER-CONVERGENCE=NOT-EVALUATED'
...
end program CHECK_B2V_REAL_RETURNED
