#!/usr/bin/env python3
"""Atomically publish one completed B2y evidence directory without replacement."""
...
def fail(message: str) -> None:
    raise SystemExit(f"B2Y ATOMIC PUBLICATION FAILURE: {message}")
...
def main() -> None:
    ...
    print("B2Y ATOMIC NO-REPLACE PUBLICATION PASS")
