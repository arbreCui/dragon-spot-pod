module B2F_STUB_PROBES
  implicit none
  integer, save :: spomoc_calls = 0
  integer, save :: xdrta2_calls = 0
  integer, save :: core_calls = 0
  integer, save :: spomoc_total = 0
  integer, save :: xdrta2_total = 0
  integer, save :: core_total = 0
contains
  subroutine B2F_RESET_TOTALS()
    spomoc_calls = 0
    xdrta2_calls = 0
    core_calls = 0
    spomoc_total = 0
    xdrta2_total = 0
    core_total = 0
  end subroutine B2F_RESET_TOTALS

  subroutine B2F_RESET_PROBES()
    spomoc_calls = 0
    xdrta2_calls = 0
    core_calls = 0
  end subroutine B2F_RESET_PROBES
end module B2F_STUB_PROBES


module SPOMOC_AUDIT
  use B2F_STUB_PROBES, only : spomoc_calls, spomoc_total
  implicit none
  private
...
module SPOR64_A9
  ...
  use B2F_STUB_PROBES, only : core_calls, core_total
  implicit none
  private
...
subroutine XDRTA2()
  use B2F_STUB_PROBES, only : xdrta2_calls, xdrta2_total
  implicit none
