subroutine SPOR64_A5_COMPILE_FAIL_REAL64_OPERATOR_DATA(kpsys, status)
  ...
  real(real64) :: wrong_volume(14), wrong_wzmu(1), wrong_zmu(1)
  ...
  call MCGFL1R64_HOST_SHAPED_POPULATION_COMPILE_ONLY_LOCKED(n, 2, nzon, &
      ...
      1, kpsys, caz1, caz2, wrong_zmu, wrong_wzmu, wrong_volume, &
      raw_response, status)
end subroutine SPOR64_A5_COMPILE_FAIL_REAL64_OPERATOR_DATA
