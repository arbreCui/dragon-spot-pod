subroutine SPOR64_A5_COMPILE_FAIL_REAL32_CAZ(kpsys, status)
  ...
  real(real32) :: volume(14), wrong_caz1(1), wrong_caz2(1)
  real(real32) :: wzmu(1), zmu(1)
  real(real64) :: fi(14,1), qn(14,1)
  ...
  call MCGFL1R64_HOST_SHAPED_POPULATION_COMPILE_ONLY_LOCKED(n, 2, nzon, &
      ...
      1, kpsys, wrong_caz1, wrong_caz2, zmu, wzmu, volume, raw_response, &
      status)
end subroutine SPOR64_A5_COMPILE_FAIL_REAL32_CAZ
