...
This rule is frozen before evaluating the proposed direct continuation
$x_7=G(x_6)$. The numerical method, rank, basis and all solver tolerances
remain unchanged.
...
- **INVALID_MAP**: a radial or axial inner solve misses its strict terminal
  ...
  fails. No candidate is published. This says that $G(x_6)$ was not
  evaluated; it is not evidence that Picard diverges.
