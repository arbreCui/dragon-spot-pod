subroutine SPOR64_A6_COMPILE_FAIL_SINGLE_GROUP_XSSC(kpsys, status)
  ...
  real(real32) :: one_group_xssc(0:m,1)
  ...
  call MCGFL1R64_DEFAULT_OFF_HOST_ADAPTER_COMPILE_ONLY_LOCKED( &
      ...
      qfr64_host, phiin64_host, m, 1, 1, 1, 1, nreg, nsout, ng, ngeff, &
      ngind, 1, 1, one_group_xssc, source64, keyflx, keycur, ibc, sigal, &
      nconv, 1, 1, 11, .false., .false., 0, 1, caz1, caz2, zmu, wzmu, &
      volume, raw_response64, route_selected, status)
end subroutine SPOR64_A6_COMPILE_FAIL_SINGLE_GROUP_XSSC
