...
*----
     ...
     1 6H WITH ,A,1H.)') IGR,'SPOT'
      ...
      ALLOCATE(RADIAL2D(NREG2D,NSNAP))
...
*----
      ...
      CALL SPOT1P(NREG2D,NFLOOR,IELEM,NMAT,NSNAP,NMODE,ISCHM,
     1 NLF,NSCT,LFIXUP,MAT1D,VOL1D,MAT,SGAR(0,II),SGAS(0,1,II),
     2 BASIS,VOL2D,RADIAL2D,NCODE,ZCODE,SUNKNO(1,II),DU,W,PL,
     3 FUNKNO(1,II),FUNKNO(LL4+1,II),FUNKNO(LL4+LL5+1,II))
*----
* END OF LOOP OVER ENERGY GROUPS
*----
      DEALLOCATE(RADIAL2D,VOL2D,BASIS)
  130 CONTINUE ! II
*----
*  PRINT CPU TIME
*----
