...
*
*----
*  INCLUDE LEAKAGE WITH SPOT METHOD
*----
      B2OLD=B2(4)
      B2HOM=DBLE(B2OLD)
      CALL B1DIF(OPTION,TYPE,NGRO,ST,SFNU,XHI,LEAK1D,IJJ0,IJJ1,NJJ0,
     1 NJJ1,SCAT0,SCAT1,REFKEF,LFISSI,IMPX,DHOM,GAMMA,B2HOM,ALAM1,CAET,
     2 A2,PHI)
      B2(4)=REAL(B2HOM)
*
