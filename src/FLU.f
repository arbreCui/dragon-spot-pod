...
*----
     ...
     2  IACITR,ILEAK,INITFL,NMERG,IMERG,IPRINT,REC,IMCAUD,LIMERG,
     3  NGRP,NREG,NMAT,NIFIS,ITPIJ,ITRANC,IPHASE,LEAKSW,LFORW,
     4  IB2STAT,CUTOFF64)
        IF(IB2STAT.EQ.SPOR64_B2B_ADMISSION_FAILED) THEN
