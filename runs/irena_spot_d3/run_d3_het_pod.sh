#!/bin/sh
#----
# run_d3_het_pod.sh -- W4 D3 heterogeneous 5-snapshot POD A/B
#
# Pincell, 5 fuel temperatures (600/700/750/800/900 C). eps_pod=1E-3.
# Output: ./d3_het_pod.log
#----
set -eu
...
rm -f _DUMMY _main* _SpotPodMic* _SpotSnapBld* _Spot* _assert* _rnr* \
      ...
      DLIB8R1_366 \
      d3_het_pod.log d3_het_pod.err 2>/dev/null || true
...
echo "==> running Dragon on irena_pincell_spot_d3_het_pod.x2m"
"$ROOT/bin/Darwin_arm64/Dragon" < irena_pincell_spot_d3_het_pod.x2m \
    > d3_het_pod.log 2> d3_het_pod.err
echo "==> Dragon exit OK; log: d3_het_pod.log"
